...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.modalOpen)('.modal', modalTimerId);
  }, 50000);
...
function cards() {
  //============== Cards ==============//
  // // Использую классы для карточек на странице
  ...
  // // Подключенная билиотека axios, которая помогает обробатывать запросы
  ...
  //     'menu__item'
  // ).render();
  // Функция для создания и добовления карточек на сайт не используя шабланизатор класса
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      form.insertAdjacentElement('afterend', statusMessage); // // Способ с XMLHttpRequest
      ...
      var formData = new FormData(form); // // Для JSON
      // const object = {};
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // // Для FormData
      // req.send(formData);
      // // Для JSON
      // req.send(json);
      // Способ с Fetch API
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.modalOpen)('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.modalClose)('.modal');
    }, 3000);
  }
}
...
function timer(id, deadline) {
  ...
  function setClock(selector, endTime) {
    ...
    deadlineSpan.textContent = "".concat(getZero(new Date(endTime).getDate()), ".").concat(getZero(new Date(endTime).getMonth() + 1), ".").concat(new Date(endTime).getFullYear());
